...
<html>
	...
	<head>
		...
		<!-- ICON -->
		<link rel="icon" type="images/png" href="Images/UBP Logo.png" />
	...
	<body>
		...
		<nav>
			<div class="nav-wrapper">
				<a href="#!" class="brand-logo"> UBP Rewards </a>
					<div class="wrap">
					   <div class="search">
				...
				<ul class="right hide-on-med-and-down">
				  ...
				  <li><a class="dropdown-button" href="#" data-activates="dropdown1"> UBP Rewards <i class="material-icons right"></i></a></li>
					  <ul id="dropdown1" class="dropdown-content">
						  <li><a href="earn.php"> Earn Points </a></li>	
	    ...
	    <ul class="slides">
	      <li>
	        ...
	        <div class="caption" id="cc">
	          <h3 id="h33"> EARN REWARDS </h3>
	          <h5 id="h55"> Earn and Redeem Rewards using our system </h5>
	      ...
	      <li>
	        ...
	        <div class="caption right-align" id="cc">
	          <h3 id="h33"> EARN POINTS </h3>
	          <h5 id="h55"="light grey-text text-lighten-3"> Making A Nice and Good Rewards Points </h5>
			  <button class="Shop"><i class="fa fa-sign-in"></i></i>&nbsp;&nbsp;Log In</button>
			  <button class="Personalize"><i class="fa fa-user-circle-o"></i>&nbsp;&nbsp;Register</button>
	        </div>
	      </li>
