				...
				<ul class="right hide-on-med-and-down">
				  ...
				  <!-- DROPDOWN STRUCTURE -->
					<ul id="dropdown1" class="dropdown-content">
					  ...
					  <li><a href="comtech.php"> Communication Technology </a></li>
					  <li><a href="electronics.php"> Electronics </a></li>
					  <li><a href="entrep.php"> Entrepreneurship </a></li>	
					  <li><a href="humanhealthcare.php"> Human Health / Health Care </a></li>
					  <li><a href="learningskills.php"> Lifelong Learning Skills </a></li>
