	  	...
	  	<div class="container">
		    ...
		    <form class="form-login" action="" method="post">
		        ...
		        <div class="login-wrap">	
		            ...
		            <input type="text" class="form-control" placeholder="Account Number" name="accountnumber" autogenerated>
		            <br>
		        	<label for=""><b> Enter Your Email Address </b></label>
		            <input type="text" class="form-control" placeholder="Email Address" name="emailaddress" autofocus>
		            <br>
