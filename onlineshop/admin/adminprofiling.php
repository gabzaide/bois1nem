          ...
          <a href="index.php" class="logo"><b> TESDA ASSESMENT CENTER DASHBOARD </b></a>
            <div class="nav notify-row" id="top_menu">
                ...
                <ul class="nav top-menu">
                    ...
                    <li class="dropdown">
                        <a data-toggle="dropdown" class="dropdown-toggle" href="adminprofiling.php">
                    ...
                    <div class="col-lg-12"><center>
                        <div class="alert alert-dismissable alert-warning">
                            <button data-dismiss="alert" class="close" type="button">&times;</button>
                             Welcome In Admin Profiling Panel, Admin!! 
                            <br/>
                        </div></center>
                    </div>
                </div>
                ...
                <div class="box">
                    <div class="box-header">
                        <div style="padding:10px;">                
                          <button class="btn btn-primary btn-sm" data-toggle="modal" data-target="#addadminprofiling"><h5><i class="fa fa-plus" aria-hidden="true"></i>&nbsp; Add Admin Profiling </h5></button>  &nbsp;&nbsp;
                          <button class="btn btn-danger btn-sm" data-toggle="modal" data-target="#deleteadminprofiling"><h6><i class="fa fa-trash-o" aria-hidden="true"></i>&nbsp;  Delete Admin Profiling </h6></button>
                        </div>                                
                                <br>
                        </div><!-- /.box-header -->
                          <div class="box-body table-responsive">
                            <form method="post">
                              <table id="table" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                  <?php
                                    $squery = mysqli_query($con, "select * from admin");
                                      while($row = mysqli_fetch_array($squery))
                                        {
                                          echo '
                                            <tr>
                                              ...
                                              <td>'.$row['password'].'</td>
                                              <td>'.$row['status'].'</td>                                              
                                              <td><button class="btn btn-primary btn-sm" data-target="#updateadminprofiling'.$row['firstname'].'" data-toggle="modal"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Update </button></td>
                                              </tr>
                                              ';
                                          
                                          include "updateadminprofiling.php";
                                        }
                                  ?>
                                </tbody>
                              </table>
              ...
              <footer class="site-footer">
                <div class="text-center">
                  © 2018 All Rights Reserved
                    <a href="adminprofiling.php" class="go-top">
