          ...
          <a href="index.php" class="logo"><b> TESDA ASSESMENT CENTER DASHBOARD </b></a>
            <div class="nav notify-row" id="top_menu">
                ...
                <ul class="nav top-menu">
                    ...
                    <li class="dropdown">
                        <a data-toggle="dropdown" class="dropdown-toggle" href="studentsprofiling.php">
      ...
      <section id="main-content">
                    ...
                    <div class="col-lg-12"><center>
                        <div class="alert alert-dismissable alert-warning">
                            <button data-dismiss="alert" class="close" type="button">&times;</button>
                             Welcome In Students Profiling Panel, Admin!! 
                            <br/>
                        </div></center>
                    </div>
                </div>
                ...
                <div class="box">
                    <div class="box-header">
                        <div style="padding:10px;">                
                          <button class="btn btn-primary btn-sm" data-toggle="modal" data-target="#addstudentprofiling"><h5><i class="fa fa-plus" aria-hidden="true"></i>&nbsp; Add Pending Students </h5></button>  &nbsp;&nbsp;
                          <button class="btn btn-danger btn-sm" data-toggle="modal" data-target="#deletestudentprofiling"><h6><i class="fa fa-trash-o" aria-hidden="true"></i>&nbsp;  Delete Pending Students </h6></button>
                        </div>                                
                                <br>
                        </div><!-- /.box-header -->
                              ...
                              <table id="table" class="table table-bordered table-striped">
                                <thead>
                                 <tr>
                                  ...
                                  <th class="sorting" tabindex="0" aria-controls="table" rowspan="1" colspan="1" aria-label="Student Number: activate to sort column ascending" style="width: 550px;"> Student Number </th>
                                  ...
                                  <th class="sorting" tabindex="0" aria-controls="table" rowspan="1" colspan="1" aria-label="Course: activate to sort column ascending" style="width: 350px;"> Course</th>
                                  <th class="sorting" tabindex="0" aria-controls="table" rowspan="1" colspan="1" aria-label="Branch: activate to sort column ascending" style="width: 350px;"> Branch </th>
                                  ...
                                  <th class="sorting" tabindex="0" aria-controls="table" rowspan="1" colspan="1" aria-label="Age: activate to sort column ascending" style="width: 350px;"> Age </th>
                                  <th class="sorting" tabindex="0" aria-controls="table" rowspan="1" colspan="1" aria-label="Gender: activate to sort column ascending" style="width: 350px;"> Gender </th>
                                  <th class="sorting" tabindex="0" aria-controls="table" rowspan="1" colspan="1" aria-label="Religion: activate to sort column ascending" style="width: 3505px;"> Religion </th>
                                  <th class="sorting" tabindex="0" aria-controls="table" rowspan="1" colspan="1" aria-label="Citizenship: activate to sort column ascending" style="width: 350px;"> Citizenship </th>
                                  <th class="sorting" tabindex="0" aria-controls="table" rowspan="1" colspan="1" aria-label="Civil Status: activate to sort column ascending" style="width: 3505px;"> Civil Status </th>
                                  <th class="sorting" tabindex="0" aria-controls="table" rowspan="1" colspan="1" aria-label="Date Of Birth: activate to sort column ascending" style="width: 350px;"> Date Of Birth </th>
                                  <th class="sorting" tabindex="0" aria-controls="table" rowspan="1" colspan="1" aria-label="Place Of Birth: activate to sort column ascending" style="width: 350px;"> Place Of  Birth </th>
                                  <th class="sorting" tabindex="0" aria-controls="table" rowspan="1" colspan="1" aria-label="Contact Number: activate to sort column ascending" style="width: 350px;"> Contact Number </th>
                                  <th class="sorting" tabindex="0" aria-controls="table" rowspan="1" colspan="1" aria-label="Address: activate to sort column ascending" style="width: 350px;"> Address </th>
                                ...
                                <tbody>
                                  <?php
                                    $squery = mysqli_query($con, "select * from students");
                                      while($row = mysqli_fetch_array($squery))
                                        {
                                          echo '
                                            <tr>
                                              ...
                                              <td>'.$row['status'].'</td>                                    
                                              <td><button class="btn btn-primary btn-sm" data-target="#updatestudentprofiling'.$row['studentid'].'" data-toggle="modal"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Update </button></td>
                                              </tr>
                                              ';
                                          
                                          include "updatestudentprofiling.php";
                                        }
                                  ?>
                                </tbody>
                              </table>
              ...
              <footer class="site-footer">
                <div class="text-center">
                  © 2018 All Rights Reserved
                    <a href="studentsprofiling.php" class="go-top">
        ...
        <!-- JAVASCRIPT -->
          <script type="text/javascript">
            $(function() {
                $("#table").dataTable({
                   "aoColumnDefs": [ { "bSortable": false, "aTargets": [ 0,19 ] } ],"aaSorting": []
                });
            });
          </script>
          <script type="text/javascript">
