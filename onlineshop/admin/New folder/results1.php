                ...
                <div class="box">
                    <div class="box-header">
                        <div style="padding:10px;">                
                          <button class="btn btn-primary btn-sm" data-toggle="modal" data-target="#addmodal"><h5><i class="fa fa-plus" aria-hidden="true"></i>&nbsp; Add Resuts </h5></button>  &nbsp;&nbsp;
                          <button class="btn btn-danger btn-sm" data-toggle="modal" data-target="#deletemodal"><h6><i class="fa fa-trash-o" aria-hidden="true"></i>&nbsp;  Delete Results </h6></button>
                        </div>                                
                                <br>
                        </div><!-- /.box-header -->
                              ...
                              <table id="table" class="table table-bordered table-striped">
                                ...
                                <thead>
                                 <tr>
                                  ...
                                  <th class="sorting" tabindex="0" aria-controls="table" rowspan="1" colspan="1" aria-label="Name: activate to sort column ascending" style="width: 255px;"> Student Name </th>
                                  ...
                                  <th class="sorting" tabindex="0" aria-controls="table" rowspan="1" colspan="1" aria-label="Date Posted: activate to sort column ascending" style="width: 255px;"> Result </th>
                                  <th class="sorting" tabindex="0" aria-controls="table" rowspan="1" colspan="1" aria-label="Result: activate to sort column ascending" style="width: 255px;"> Date Posted </th>
                                      ...
                                      while($row = mysqli_fetch_array($squery))
                                        {
                                          echo '
                                                <tr>
                                                  <td><input type="checkbox" name="chk_delete[]" class="chk_delete" value="'.$row['resultid'].'" /></td>
                                                      ...
                                                      <td><button class="btn btn-primary btn-sm" data-target="Pending#myModal'.$row['resultid'].'" data-toggle="modal"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Update </button></td>
                                                      </tr>
                                                    <tbody>';
