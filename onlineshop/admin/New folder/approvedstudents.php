          ...
          <a href="index.php" class="logo"><b> TESDA ASSESMENT CENTER DASHBOARD </b></a>
            <div class="nav notify-row" id="top_menu">
                ...
                <ul class="nav top-menu">
                    ...
                    <li class="dropdown">
                        <a data-toggle="dropdown" class="dropdown-toggle" href="approvedstudents.php">
                ...
                <div class="box">
                    <div class="box-header">
                        <div style="padding:10px;">                
                          <button class="btn btn-primary btn-sm" data-toggle="modal" data-target="#addapprovedstudents"><h5><i class="fa fa-plus" aria-hidden="true"></i>&nbsp; Add Approved Students </h5></button>  &nbsp;&nbsp;
                          <button class="btn btn-danger btn-sm" data-toggle="modal" data-target="#deleteapprovedstudents"><h6><i class="fa fa-trash-o" aria-hidden="true"></i>&nbsp;  Delete Approved Students </h6></button>
                        </div>                                
                                <br>
                        </div><!-- /.box-header -->
                          <div class="box-body table-responsive">
                            <form method="post">
                              <table id="table" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                  <?php 
                                     $sql = "SELECT * FROM students WHERE status = 'Approved' ORDER BY studentid desc";
                                      $sqlq = mysqli_query($con , $sql);
                                          while ($row = mysqli_fetch_assoc($sqlq)) 
                                            ...
                                            <tr>
                                              ...
                                              <td>'.$row['status'].'</td>                                    
                                              <td><button class="btn btn-primary btn-sm" data-target="#pendingmodal'.$row['studentid'].'" data-toggle="modal"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Update </button></td>
                                              </tr>
                                              ';
